...
class VideoCompactParser {
    static loadVideoCompact(target, data) {
        var _a, _b, _c;
        const { videoId, title, headline, lengthText, thumbnail, ownerText, shortBylineText, publishedTimeText, viewCountText, badges, thumbnailOverlays, channelThumbnailSupportedRenderers, detailedMetadataSnippets, ownerBadges} = data;
        target.id = videoId;
